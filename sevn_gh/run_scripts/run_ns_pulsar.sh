...
RLMODE="hurley_rl_propeller" #Prescriptions for Roche-Lobe overflow and mass transfer/accretion - [hurley_rl*] [hurley_bse] [disabled]
...
CKSTALLINGTIME="5" #Time in seconds (units granularity) after which the system is considered stalled and the evolution is stopped and an error is raised)
