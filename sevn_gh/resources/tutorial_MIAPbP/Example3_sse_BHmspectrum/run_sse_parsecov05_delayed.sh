...
#OUTPUT
#-------------------------------
OUTPATH="sevn_output_parsecov05_delayed/" #Complete path to the output folder (the folder will be automatically created or cleaned if it already exists)
...
SUPERNOVA="delayed" #Prescription for the SN explosion mechanism - [list*] [rapid] [rapid_gauNS] [delayed] [delayed_gauNS] [compact] [deathmatrix] [directcollapse]
