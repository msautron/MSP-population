...
#OUTPUT
#-------------------------------
OUTPATH="sevn_output_parsecov05_compactness/" #Complete path to the output folder (the folder will be automatically created or cleaned if it already exists)
...
SUPERNOVA="compact" #Prescription for the SN explosion mechanism - [list*] [rapid] [rapid_gauNS] [delayed] [delayed_gauNS] [compact] [deathmatrix] [directcollapse]
